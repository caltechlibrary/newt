...
YAML file.  newt first sends requests to Postgres+PostgREST
then processes the results via Pandoc running as a web service.
While newt was created to work specifically with PostgREST
...
For newt to function as a data router it needs information

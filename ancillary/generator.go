...
var (
	// SQLTypes is a map our dsl input types to SQL types.
	SQLTypes = map[string]string{
		"input":   "varchar(256) default ''",
		"textarea":     "text default ''",
		"input[type=integer]":  "integer default 0",
		"input[type=real]":     "real default 0.0",
		"input[type=bool]":  "boolean",
		"input[type=date]":     "date",
		"input[type=year]":     "integer default 0",
		"input[type=month]":    "integer default 0",
		"input[type=day]":      "integer default 0",
		"input[type=isbn10]":   "varchar(10) default ''",
		"input[type=isbn13":   "varchar(13) default ''",
		"input[type=isbn]":     "varchar(13) default ''",
		"input[type=issn]":     "varchar(9) default ''",
		"input[type=doi]":      "varchar(256) default ''",
		"input[type=isni]":     "varchar(16) default ''",
		"input[type=orcid]":    "varchar(19) default ''",
		"input[type=arxiv]":    "varchar(10) default ''",
		"markdown": "text default ''",
		"dropdown": "text[][]",
		"checkboxes": "text[][]",
		"input[type=ror]":      "varchar(25)",
		// FIXME: find out the actual max length of URL if exists
		"input[type=url]":      "varchar(1028)",
		// FIXME: find out the actual max length of an email address if exists
		"input[type=email]":    "varchar(256)",
		"input[type=timestamp]": "timestamp",
	}
